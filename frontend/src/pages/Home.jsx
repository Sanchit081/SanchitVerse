  ...
  return (
    <>
      ...
      <div className="font-body bg-white text-[#1E1E28] relative overflow-hidden pb-28">
          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative w-20 h-20 md:w-24 md:h-24 flex items-end justify-around p-2">
                  <motion.div
                    className="absolute inset-0 border-4 border-t-[#3D52A0] border-r-transparent border-b-transparent border-l-transparent rounded-full"
                    animate={{ rotate: [0, 360] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear' }}
                  />
                  <motion.div
                    className="absolute inset-0 border-4 border-t-transparent border-r-[#7091E6] border-b-transparent border-l-transparent rounded-full"
                    animate={{ rotate: [0, -360] }}
                    transition={{ duration: 2, repeat: Infinity, ease: 'linear' }}
                  />
                </div>
        ...
        {/* --- */}
        {/* We Grow With You Section */}
        <section className="py-24 bg-white text-[#1E1E28] relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 px-4 relative z-10">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-[#3D52A0]">We Grow With You</h2>
              <p className="text-[#555] mb-6 max-w-lg mx-auto md:mx-0">
                Join our community and get access to exclusive resources, early product alerts, and insights to accelerate your growth.
              </p>
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 mt-6">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-2 border rounded-md focus:ring-[#7091E6] focus:border-[#7091E6] transition-colors"
                />
                <button
                  type="submit"
                  className="px-6 py-3 bg-[#7091E6] text-white rounded-lg font-semibold hover:bg-[#3D52A0] transition-all shadow-lg"
              ...
              <AnimatePresence>
                {isSubscribed && (
                  <motion.p
                    ...
                    className="mt-4 text-sm text-[#3D52A0] font-medium"
                  >
                    Thanks for subscribing and getting exciting offers!
                  </motion.p>
                )}
              </AnimatePresence>
            </motion.div>
            ...
            >
              <Player
                autoplay
                loop
                src={ComputerAnim} // Using the existing animation file
                style={{
                  height: '300px',
                  width: '100%',
                  maxWidth: '500px'
